...
(defn init-through-2-y-z []
  (jdbc/do-commands
   ...
   "CREATE TABLE catalogs (
    ...
    hash character varying(40) NOT NULL UNIQUE,
    api_version integer,
   ...
   "ALTER SEQUENCE catalogs_transform_id_seq1 OWNED BY catalogs.id"
   ...
   "CREATE TABLE fact_values (
    ...
    value_hash character varying(40) NOT NULL UNIQUE,
   ...
   "CREATE TABLE reports (
    hash character varying(40) NOT NULL PRIMARY KEY,
    certname text,
   ...
   "CREATE TABLE resource_params_cache (
    resource character varying(40) NOT NULL PRIMARY KEY,
    parameters text)"
