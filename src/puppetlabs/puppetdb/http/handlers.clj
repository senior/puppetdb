...
(pls/defn-validated wrap-with-parent-check-m :- bidi-schema/RoutePair
  ...
  (cmdi/routes
   ...
   (cmdi/context ["/" :hash "/events"]
                 (-> (events-routes version)
                     ...
                     (wrap-with-parent-check-m version :report :hash)))
      ...
      (cmdi/context ["/" :node]
                    ...
                    (cmdi/context "/facts"
                                  (-> (facts-routes version)
                                      ...
                                      (wrap-with-parent-check-m version :node :node)))
